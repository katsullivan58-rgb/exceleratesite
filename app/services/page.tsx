...
const EMAIL = "exceleratekas@gmail.com"; // <-- change

export default function Services() {
  return (
    <main className="mx-auto max-w-6xl px-6 py-20">
      <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs text-blue-800">
      ...
      {/* WHAT YOU GET */}
      <div className="mt-16 rounded-2xl border border-blue-100 bg-white p-8">
